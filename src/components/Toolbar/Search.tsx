...
function Search({
  ...
  return (
    <>
      ...
      {page == "rides" && (
        <MDBInputGroup className="mb-3  mt-3 p-3 date-time-picker">
          <MDBBtn
            color="info"
            className="flex-grow-1 bg-light buttonstyle border-info "
            outline
            noRipple
          >
            Start Date
          ...
          <MDBBtn
            color="info"
            className="buttonstyle bg-light flex-grow-1 border-info ms-2"
            outline
            noRipple
          >
            End Date
          ...
          />
          <select
            className="form-selectt border-1 border-info bg-light text-info ms-3 me-1 flex-grow-1 flex-end
          "
