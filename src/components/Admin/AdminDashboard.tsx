...
export default function UserDashboard(): JSX.Element {
  ...
  const [tableFilters, setTableFilters] =
    useState<GenericObject>(initialTableFilters);
  const [showUserFormModel, setShowUserFormModel] = useState<boolean>(false);
  ...
  function handleSearchField(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (!event.target.value.length) setTableFilters({ ...initialTableFilters });
  }
